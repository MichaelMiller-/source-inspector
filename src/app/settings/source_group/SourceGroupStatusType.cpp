...
std::string sourceGroupStatusTypeToString(SourceGroupStatusType v)
{
   ...
   LOG_WARNING("Trying to convert unknown Source Group status type to string, falling back to disabled "
               "status.");
   return "disabled";
}
...
SourceGroupStatusType stringToSourceGroupStatusType(std::string v)
{
   ...
   LOG_WARNING("Trying to convert unknown string to Source Group status type, falling back to disabled "
               "status.");
   return SOURCE_GROUP_STATUS_DISABLED;
}
