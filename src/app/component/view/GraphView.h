...
class GraphView : public View, public ScreenSearchResponder
{
public:
   ...
   virtual void rebuildGraph(std::shared_ptr<Graph> graph, const std::vector<std::shared_ptr<DummyNode>>& nodes,
                             const std::vector<std::shared_ptr<DummyEdge>>& edges, const GraphParams params) = 0;
   ...
   virtual math::Vec2i getViewSize() const = 0;
