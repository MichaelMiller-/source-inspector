...
public:
   ...
   virtual bool setPosition(const math::Vec2i& position);

   const math::Vec2i& getSize() const;
   void setSize(const math::Vec2i& size);

   const math::Vec2i& getColumnSize() const;
   void setColumnSize(const math::Vec2i& size);

   QSize size() const;
   void setSize(QSize size);

   math::Vec4i getBoundingRect() const;
   ...
   virtual void moved(const math::Vec2i& oldPosition);
