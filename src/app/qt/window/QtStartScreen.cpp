...
bool QtRecentProjectButton::projectExists() const { return m_projectExists; }
...
void QtStartScreen::setupStartScreen()
{
...

   {
      ...
      QLabel* versionLabel =
         new QLabel(("Version " + Version::getApplicationVersion().toDisplayString()).c_str(), this);
...
void QtStartScreen::handleNewProjectButton() { emit openNewProjectDialog(); }

void QtStartScreen::handleOpenProjectButton() { emit openOpenProjectDialog(); }

void QtStartScreen::handleRecentButton() { emit finished(); }
