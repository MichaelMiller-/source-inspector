...
CxxVs10To14HeaderPathDetector::CxxVs10To14HeaderPathDetector(VisualStudioType type, bool isExpress,
    ...
    : PathDetector(visualStudioTypeToString(type) + (isExpress ? " Express" : "") +
      ...
      m_version(visualStudioTypeToVersion(type)), m_isExpress(isExpress), m_architecture(architecture)
{
}
