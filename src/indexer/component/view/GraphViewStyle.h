...
{
public:
   static math::Vec2i alignOnRaster(math::Vec2i position);
   ...
   struct NodeStyle
   {
      ...
      math::Vec2i textOffset;

      FilePath iconPath;
      math::Vec2i iconOffset;
      size_t iconSize;
   ...
   struct EdgeStyle
   {
      ...
      math::Vec2i originOffset;
      math::Vec2i targetOffset;
   ...
   static NodeStyle getStyleForNodeType(NodeType type, bool defined, bool isActive, bool isFocused, bool isCoFocused,
...
private:
   static NodeStyle getStyleForNodeType(NodeType::StyleType type, const std::string& underscoredTypeString,
                                        const FilePath& iconPath, bool defined, bool isActive, bool isFocused,
                                        bool isCoFocused, bool hasChildren, bool hasQualifier);
