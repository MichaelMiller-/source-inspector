...
math::Vec2i GraphViewStyle::alignOnRaster(math::Vec2i position)
{
...
GraphViewStyle::NodeMargins::NodeMargins()
    : left(0), right(0), top(0), bottom(0), spacingX(0), spacingY(0), spacingA(0), minWidth(0), charWidth(0.0f),
      charHeight(0.0f), iconWidth(0)
{
}

GraphViewStyle::NodeStyle::NodeStyle()
    : cornerRadius(0), borderWidth(0), borderDashed(false), fontSize(0), fontBold(false), iconSize(0),
      hasHatching(false)
{
}

GraphViewStyle::EdgeStyle::EdgeStyle()
    : width(0), zValue(0), arrowLength(0), arrowWidth(0), arrowClosed(false), cornerRadius(0), verticalOffset(0),
      dashed(false)
{
}
...
void GraphViewStyle::setImpl(std::shared_ptr<GraphViewStyleImpl> impl) { s_impl = impl; }
...
size_t GraphViewStyle::getFontSizeOfAccessNode() { return s_fontSize - 2; }

size_t GraphViewStyle::getFontSizeOfExpandToggleNode() { return s_fontSize - 3; }

size_t GraphViewStyle::getFontSizeOfCountCircle() { return s_fontSize - 3; }

size_t GraphViewStyle::getFontSizeOfQualifier() { return s_fontSize - 3; }

size_t GraphViewStyle::getFontSizeOfTextNode(int fontSizeDiff) { return s_fontSize + fontSizeDiff; }

size_t GraphViewStyle::getFontSizeOfGroupNode() { return getFontSizeForStyleType(NodeType::STYLE_GROUP); }

std::string GraphViewStyle::getFontNameForDataNode() { return s_fontName + ", consolas, monospace, sans-serif"; }

std::string GraphViewStyle::getFontNameOfAccessNode() { return "Fira Sans, sans-serif"; }

std::string GraphViewStyle::getFontNameOfExpandToggleNode() { return "Fira Sans, sans-serif"; }

std::string GraphViewStyle::getFontNameOfTextNode() { return "Fira Sans, sans-serif"; }

std::string GraphViewStyle::getFontNameOfGroupNode() { return s_fontName + ", consolas, monospace, sans-serif"; }

GraphViewStyle::NodeMargins GraphViewStyle::getMarginsForDataNode(NodeType::StyleType type, bool hasIcon,
                                                                  bool hasChildren)
{
   NodeMargins margins;
   margins.spacingX = 6;
...
GraphViewStyle::NodeStyle GraphViewStyle::getStyleForNodeType(NodeType type, bool defined, bool isActive,
                                                              bool isFocused, bool isCoFocused, bool hasChildren,
                                                              bool hasQualifier)
{
   return getStyleForNodeType(type.getNodeStyle(), type.getUnderscoredTypeString(), type.getIconPath(), defined,
                              isActive, isFocused, isCoFocused, hasChildren, hasQualifier);
}
...
GraphViewStyle::NodeStyle GraphViewStyle::getStyleForNodeType(NodeType::StyleType type,
                                                              ...
                                                              const FilePath& iconPath, bool defined, bool isActive,
                                                              bool isFocused, bool isCoFocused, bool hasChildren,
                                                              bool hasQualifier)
{
   NodeStyle style;
...
GraphViewStyle::EdgeStyle GraphViewStyle::getStyleForEdgeType(Edge::EdgeType type, bool isActive, bool isFocused,
                                                              bool isTrailEdge, bool isAmbiguous)
{
   EdgeStyle style;
...
{
   if (x > 0) {
      return static_cast<int>(std::ceil(x / double(s_gridCellPadding + s_gridCellSize)) *
                              (s_gridCellPadding + s_gridCellSize));
   } else {
      return static_cast<int>(std::floor(x / double(s_gridCellPadding + s_gridCellSize)) *
                              (s_gridCellPadding + s_gridCellSize));
   }
}

int GraphViewStyle::toGridSize(int x) { return s_gridCellSize + toGridOffset(x - s_gridCellSize); }

int GraphViewStyle::toGridGap(int x) { return s_gridCellPadding + toGridOffset(x - s_gridCellPadding); }

float GraphViewStyle::getZoomFactor() { return s_zoomFactor; }
