...
StatusBarView* StatusBarController::getView() { return Controller::getView<StatusBarView>(); }

void StatusBarController::clear() { getView()->setErrorCount(ErrorCountInfo()); }

void StatusBarController::handleMessage(MessageErrorCountClear* message) { getView()->setErrorCount(ErrorCountInfo()); }
...
void StatusBarController::handleMessage(MessageIndexingStarted* message) { getView()->showIndexingProgress(0); }
