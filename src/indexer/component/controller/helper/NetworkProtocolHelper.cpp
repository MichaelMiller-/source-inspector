...
NetworkProtocolHelper::SetActiveTokenMessage
NetworkProtocolHelper::parseSetActiveTokenMessage(const std::wstring& message)
{
   std::vector<std::wstring> subMessages = divideMessage(message);
...
NetworkProtocolHelper::CreateProjectMessage
NetworkProtocolHelper::parseCreateProjectMessage(const std::wstring& message)
{
   std::vector<std::wstring> subMessages = divideMessage(message);
...
NetworkProtocolHelper::CreateCDBProjectMessage
NetworkProtocolHelper::parseCreateCDBProjectMessage(const std::wstring& message)
{
   std::vector<std::wstring> subMessages = divideMessage(message);
...
std::wstring NetworkProtocolHelper::buildSetIDECursorMessage(const FilePath& fileLocation, const unsigned int row,
