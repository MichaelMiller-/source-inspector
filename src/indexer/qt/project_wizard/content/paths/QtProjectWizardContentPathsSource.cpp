...
bool QtProjectWizardContentPathsSource::check()
{
   if (m_list->getPathsAsDisplayed().empty()) {
      ...
      msgBox.setInformativeText(QStringLiteral("Sourcetrail will not index any files for this Source Group. Please add "
...
QString QtProjectWizardContentPathsSource::getFileNamesTitle() const { return QStringLiteral("Indexed Files"); }
