...
void QtProjectWizardContentSelect::populate(QGridLayout* layout, int& row)
{
   ...
   {
      SourceGroupInfo(SourceGroupType type, bool recommended = false) : type(type), recommended(recommended) {}
   ...
   m_sourceGroupTypeDescriptions[SOURCE_GROUP_CXX_CDB] =
      ...
      "<a href=\"" +
      utility::getDocumentationLink() + "#cc-source-group-from-compilation-database\">documentation</a>.";
   m_sourceGroupTypeDescriptions[SOURCE_GROUP_CXX_VS] =
      ...
      "<a href=\"" +
      utility::getDocumentationLink() + "#visual-studio\">Sourcetrail Visual Studio Extension</a> installed.</p>";
