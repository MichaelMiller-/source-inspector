...
QtProjectWizardContent* QtProjectWizardWindow::content() const { return m_content; }

void QtProjectWizardWindow::setContent(QtProjectWizardContent* content) { m_content = content; }

void QtProjectWizardWindow::setPreferredSize(QSize size) { m_preferredSize = size; }

void QtProjectWizardWindow::saveContent() { m_content->save(); }

void QtProjectWizardWindow::loadContent() { m_content->load(); }

void QtProjectWizardWindow::refreshContent() { m_content->refresh(); }
