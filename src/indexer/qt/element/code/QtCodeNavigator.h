...
class QtCodeNavigator : public QWidget, public CodeFocusHandler, public MessageListener<MessageWindowFocus>
{
   Q_OBJECT

public:
   enum Mode { MODE_NONE, MODE_LIST, MODE_SINGLE };

   explicit QtCodeNavigator(QWidget* parent = nullptr);
   ~QtCodeNavigator() override = default;
   ...
   void updateReferenceCount(size_t referenceCount, size_t referenceIndex, size_t localReferenceCount,
...
private:
   ...
   QtCodeNavigable* m_current{nullptr};
