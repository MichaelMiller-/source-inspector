...
class QtGraphEdge : public QObject, public QGraphicsItemGroup
{
   Q_OBJECT
...
public:
   ...
   QtGraphEdge(GraphFocusHandler* focusHandler, QtGraphNode* owner, QtGraphNode* target, const Edge* data,
   ...
   void setIsTrailEdge(const std::vector<math::Vec4i>& path, bool horizontal);
