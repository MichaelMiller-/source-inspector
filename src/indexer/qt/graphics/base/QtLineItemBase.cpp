...
void QtLineItemBase::updateLine(const math::Vec4i& ownerRect, const math::Vec4i& targetRect, const math::Vec4i& ownerParentRect,
...
void QtLineItemBase::getPivotPoints(math::Vec2f* p, const math::Vec4i& in, const math::Vec4i& out, int offset, bool target) const
{
   float f = 1 / 2.f;
