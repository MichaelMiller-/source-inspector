                               ...
                               const std::vector<std::shared_ptr<DummyEdge>>& edges, const GraphParams params)
{
   m_onQtThread([=]() {
      ...
      const auto o = GraphViewStyle::alignOnRaster(math::Vec2i(static_cast<int>(center.x()), static_cast<int>(center.y())));
...
math::Vec2i QtGraphView::getViewSize() const
{
   ...
   return math::Vec2i(static_cast<int>((view->width() - 50) / zoomFactor),
...
void QtGraphView::ensureNodeVisible(QtGraphNode* node)
{
   ...
   math::Vec4i r = node->getBoundingRect();
