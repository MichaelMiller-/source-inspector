...
QtWindow::QtWindow(bool isSubWindow, QWidget* parent)
    : QtWindowBase(isSubWindow, parent), m_title(nullptr), m_subTitle(nullptr), m_nextButton(nullptr),
      m_previousButton(nullptr), m_closeButton(nullptr), m_scrollAble(false), m_hasLogo(false)
{
}
...
void QtWindow::setScrollAble(bool scrollAble) { m_scrollAble = scrollAble; }

bool QtWindow::isScrollAble() const { return m_scrollAble; }
...
void QtWindow::closeEvent(QCloseEvent*) { handleClose(); }
...
void QtWindow::populateWindow(QWidget*) {}

void QtWindow::windowReady() {}

void QtWindow::handleNext() { emit finished(); }

void QtWindow::handlePrevious() { emit previous(); }

void QtWindow::handleClose() { emit canceled(); }
...
void QtWindow::handleNextPress(bool) { handleNext(); }

void QtWindow::handlePreviousPress() { handlePrevious(); }

void QtWindow::handleClosePress() { handleClose(); }
