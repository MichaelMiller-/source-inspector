...
void QtBookmarkBrowser::setupBookmarkBrowser()
{
...

   {
      ...
      connect(m_filterComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this,
      ...
      connect(m_orderComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), this,
              &QtBookmarkBrowser::filterOrOrderChanged);
   }
...
void QtBookmarkBrowser::handleClose() { close(); }

void QtBookmarkBrowser::handleNext() { close(); }
