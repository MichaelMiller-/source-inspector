...
bool NameElement::Signature::isValid() const { return !m_prefix.empty() || !m_postfix.empty(); }

const std::wstring& NameElement::Signature::getPrefix() const { return m_prefix; }

const std::wstring& NameElement::Signature::getPostfix() const { return m_postfix; }
...
const std::wstring& NameElement::getName() const { return m_name; }

std::wstring NameElement::getNameWithSignature() const { return m_signature.qualifyName(m_name); }

std::wstring NameElement::getNameWithSignatureParameters() const { return m_name + m_signature.getParameterString(); }

bool NameElement::hasSignature() const { return m_signature.isValid(); }

const NameElement::Signature& NameElement::getSignature() const { return m_signature; }
