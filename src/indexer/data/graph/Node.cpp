...
Node::Node(Id id, NodeType type, NameHierarchy nameHierarchy, DefinitionKind definitionKind)
    : Token(id), m_type(type), m_nameHierarchy(std::move(nameHierarchy)), m_definitionKind(definitionKind),
      m_childCount(0)
{
}

Node::Node(const Node& other)
    : Token(other), m_type(other.m_type), m_nameHierarchy(other.m_nameHierarchy),
      m_definitionKind(other.m_definitionKind), m_childCount(other.m_childCount)
{
}
