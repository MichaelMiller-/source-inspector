...
Id Token::getId() const { return m_id; }

const std::vector<Id>& Token::getLocationIds() const { return m_locationIds; }

void Token::addLocationId(Id locationId) { m_locationIds.push_back(locationId); }
...
void Token::addComponent(std::shared_ptr<TokenComponent> component) { m_components.push_back(component); }
