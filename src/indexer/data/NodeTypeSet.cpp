...
NodeTypeSet NodeTypeSet::none() { return NodeTypeSet(); }

NodeTypeSet::NodeTypeSet() { m_nodeTypeMask = 0; }

NodeTypeSet::NodeTypeSet(const NodeType& type) : m_nodeTypeMask(nodeTypeToMask(type)) {}

bool NodeTypeSet::operator==(const NodeTypeSet& other) const { return m_nodeTypeMask == other.m_nodeTypeMask; }

bool NodeTypeSet::operator!=(const NodeTypeSet& other) const { return !operator==(other); }
...
void NodeTypeSet::invert() { m_nodeTypeMask = ~m_nodeTypeMask; }

void NodeTypeSet::add(const NodeTypeSet& typeSet) { m_nodeTypeMask |= typeSet.m_nodeTypeMask; }

void NodeTypeSet::remove(const NodeTypeSet& typeSet) { m_nodeTypeMask &= ~typeSet.m_nodeTypeMask; }
...
bool NodeTypeSet::isEmpty() const { return m_nodeTypeMask == 0; }

bool NodeTypeSet::contains(const NodeType& type) const { return m_nodeTypeMask & nodeTypeToMask(type); }
...
bool NodeTypeSet::intersectsWith(const NodeTypeSet& typeSet) const { return m_nodeTypeMask & typeSet.m_nodeTypeMask; }
