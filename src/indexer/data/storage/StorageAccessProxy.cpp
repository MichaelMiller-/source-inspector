...
void StorageAccessProxy::setSubject(std::weak_ptr<StorageAccess> subject) { m_subject = subject; }
...
#define DEF_GETTER_4(_METHOD_NAME_, _PARAM_1_TYPE_, _PARAM_2_TYPE_, _PARAM_3_TYPE_, _PARAM_4_TYPE_, _RETURN_TYPE_,     \
                     _DEFAULT_VALUE_)                                                                                  \
   UNWRAP(_RETURN_TYPE_)                                                                                               \
   StorageAccessProxy::_METHOD_NAME_(_PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4) const \
   {                                                                                                                   \
      if (std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                 \
...
#define DEF_GETTER_5(_METHOD_NAME_, _PARAM_1_TYPE_, _PARAM_2_TYPE_, _PARAM_3_TYPE_, _PARAM_4_TYPE_, _PARAM_5_TYPE_,    \
                     _RETURN_TYPE_, _DEFAULT_VALUE_)                                                                   \
   UNWRAP(_RETURN_TYPE_)                                                                                               \
   StorageAccessProxy::_METHOD_NAME_(_PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4,       \
                                     _PARAM_5_TYPE_ p5) const                                                          \
   {                                                                                                                   \
      if (std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                 \
...
#define DEF_GETTER_6(_METHOD_NAME_, _PARAM_1_TYPE_, _PARAM_2_TYPE_, _PARAM_3_TYPE_, _PARAM_4_TYPE_, _PARAM_5_TYPE_,    \
                     _PARAM_6_TYPE_, _RETURN_TYPE_, _DEFAULT_VALUE_)                                                   \
   UNWRAP(_RETURN_TYPE_)                                                                                               \
   StorageAccessProxy::_METHOD_NAME_(_PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4,       \
                                     _PARAM_5_TYPE_ p5, _PARAM_6_TYPE_ p6) const                                       \
   {                                                                                                                   \
      if (std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                 \
...
#define DEF_GETTER_7(_METHOD_NAME_, _PARAM_1_TYPE_, _PARAM_2_TYPE_, _PARAM_3_TYPE_, _PARAM_4_TYPE_, _PARAM_5_TYPE_,    \
                     _PARAM_6_TYPE_, _PARAM_7_TYPE_, _RETURN_TYPE_, _DEFAULT_VALUE_)                                   \
   UNWRAP(_RETURN_TYPE_)                                                                                               \
   StorageAccessProxy::_METHOD_NAME_(_PARAM_1_TYPE_ p1, _PARAM_2_TYPE_ p2, _PARAM_3_TYPE_ p3, _PARAM_4_TYPE_ p4,       \
                                     _PARAM_5_TYPE_ p5, _PARAM_6_TYPE_ p6, _PARAM_7_TYPE_ p7) const                    \
   {                                                                                                                   \
      if (std::shared_ptr<StorageAccess> subject = m_subject.lock()) {                                                 \
...
DEF_GETTER_2(getFullTextSearchLocations, const std::wstring&, bool, std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
DEF_GETTER_3(getAutocompletionMatches, const std::wstring&, NodeTypeSet, bool, std::vector<SearchMatch>,
...
DEF_GETTER_3(getGraphForActiveTokenIds, const std::vector<Id>&, const std::vector<Id>&, bool*, std::shared_ptr<Graph>,
             std::make_shared<Graph>())
DEF_GETTER_1(getGraphForChildrenOfNodeId, Id, std::shared_ptr<Graph>, std::make_shared<Graph>())
DEF_GETTER_7(getGraphForTrail, Id, Id, NodeKindMask, Edge::TypeMask, bool, size_t, bool, std::shared_ptr<Graph>,
             std::make_shared<Graph>())
...
DEF_GETTER_1(getSourceLocationsForTokenIds, const std::vector<Id>&, std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
DEF_GETTER_1(getSourceLocationsForLocationIds, const std::vector<Id>&, std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
DEF_GETTER_1(getSourceLocationsForFile, const FilePath&, std::shared_ptr<SourceLocationFile>,
             std::make_shared<SourceLocationFile>(FilePath(), L"", false, false, false))
DEF_GETTER_3(getSourceLocationsForLinesInFile, const FilePath&, size_t, size_t, std::shared_ptr<SourceLocationFile>,
             std::make_shared<SourceLocationFile>(FilePath(), L"", false, false, false))
DEF_GETTER_2(getSourceLocationsOfTypeInFile, const FilePath&, LocationType, std::shared_ptr<SourceLocationFile>,
             std::make_shared<SourceLocationFile>(FilePath(), L"", false, false, false))
...
DEF_GETTER_1(getErrorSourceLocations, const std::vector<ErrorInfo>&, std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
...
void StorageAccessProxy::updateBookmark(const Id bookmarkId, const std::wstring& name, const std::wstring& comment,
...
DEF_GETTER_2(getTooltipInfoForSourceLocationIdsAndLocalSymbolIds, const std::vector<Id>&, const std::vector<Id>&,
