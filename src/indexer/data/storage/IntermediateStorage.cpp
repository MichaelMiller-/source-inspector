...
size_t IntermediateStorage::getSourceLocationCount() const { return m_sourceLocations.size(); }
...
void IntermediateStorage::addSymbol(const StorageSymbol& symbol) { m_symbols.push_back(symbol); }
...
void IntermediateStorage::addOccurrence(const StorageOccurrence& occurrence) { m_occurrences.emplace(occurrence); }
...
const std::vector<StorageNode>& IntermediateStorage::getStorageNodes() const { return m_nodes; }

const std::vector<StorageFile>& IntermediateStorage::getStorageFiles() const { return m_files; }

const std::vector<StorageSymbol>& IntermediateStorage::getStorageSymbols() const { return m_symbols; }

const std::vector<StorageEdge>& IntermediateStorage::getStorageEdges() const { return m_edges; }

const std::set<StorageLocalSymbol>& IntermediateStorage::getStorageLocalSymbols() const { return m_localSymbols; }
...
const std::set<StorageOccurrence>& IntermediateStorage::getStorageOccurrences() const { return m_occurrences; }
...
const std::vector<StorageError>& IntermediateStorage::getErrors() const { return m_errors; }
...
Id IntermediateStorage::getNextId() const { return m_nextId; }

void IntermediateStorage::setNextId(const Id nextId) { m_nextId = nextId; }
