   ...
   const std::shared_ptr<IntermediateStorage>& intermediateStorage)
{
   ...
   const size_t requiredSize =
      (intermediateStorage->getByteSize(sizeof(SharedMemory::String)) + sizeof(SharedIntermediateStorage)) *
